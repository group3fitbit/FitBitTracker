...
package fragtest.mingninja.net.fragtest;
...
import static fragtest.mingninja.net.fragtest.UserProgress.Users;
...
/* DELETE ME I AM A TEST - END ==========================================================*/
        ...
        fragtest.mingninja.net.fragtest.ChallengeListAdapter currentAdapter = new fragtest.mingninja.net.fragtest.ChallengeListAdapter(challengeData,"current"); //place your String array in place of MyString
        fragtest.mingninja.net.fragtest.ChallengeListAdapter pastAdapter = new fragtest.mingninja.net.fragtest.ChallengeListAdapter(challengeData,"past"); //place your String array in place of MyString
